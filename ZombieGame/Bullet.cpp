...
void Bullet::draw(WMPEngine::SpriteBatch& spriteBatch) {
    ...
    spriteBatch.draw(destRect, uvRect, WMPEngine::ResourceManager::getTexture("Textures/circle.png").id, 0.0f, color);
}
